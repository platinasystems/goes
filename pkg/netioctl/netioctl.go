...
var (
	...
	NewIfReqSockaddrIn  = NewIfReq[xnet.SAIn]
	NewIfReqSockaddrIn6 = NewIfReq[xnet.SAIn6]
)
...
func Inet6[R IfReq[In6Alias] | IfReq[xnet.SAIn6]](
	op uintptr, req *R,
) error {
	inet6, err := xnet.OpenInet6()
	if err != nil {
		return err
	}
	defer xnet.Close(inet6)
