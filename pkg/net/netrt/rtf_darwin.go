...
const (
	...
	RTF_DELCLONE  = syscall.RTF_DELCLONE  // 0x00000080
	RTF_CLONING   = syscall.RTF_CLONING   // 0x00000100
	...
	RTF_WASCLONED = syscall.RTF_WASCLONED // 0x00020000
	...
	RTF_IFSCOPE   = syscall.RTF_IFSCOPE   // 0x01000000
	RTF_CONDEMNED = syscall.RTF_CONDEMNED // 0x02000000
	RTF_IFREF     = syscall.RTF_IFREF     // 0x04000000
	RTF_PROXY     = syscall.RTF_PROXY     // 0x08000000
	RTF_ROUTER    = syscall.RTF_ROUTER    // 0x10000000
	RTF_ANNOUNCE  = 0
	RTF_FIXEDMTU  = 0
	RTF_STICKY    = 0
)
