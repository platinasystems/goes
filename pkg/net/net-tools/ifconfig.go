...
func Ifconfig(ctx context.Context, args []string) error {
	...
	if goes.ContextHelp(ctx) {
		return goes.Usage(ctx, IfconfigUsage)
	}
	if len(*XFlag) > 0 {
