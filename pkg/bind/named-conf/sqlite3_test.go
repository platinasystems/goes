...
func TestDataSQLite3(t *testing.T) {
	testdata(t, fnSqlite3, expectSqlite3)
}

const fnSqlite3 = "testdata/bind9/contrib/dlz/modules/sqlite3/testing/named.conf"

var expectSqlite3 = Conf{
