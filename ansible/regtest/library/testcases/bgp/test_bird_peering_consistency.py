#!/usr/bin/python
""" Test/Verify BIRD PEERING CONSISTENCY """
...
DOCUMENTATION = """
---
module: test_bird_peering_consistency
...
EXAMPLES = """
- name: Verify bird peering consistency
  test_bird_peering_consistency:
...
def verify_bird_peering_consistency(module):
    """
    Method to verify bird peering consistency.
    :param module: The Ansible module to fetch input parameters.
    """
