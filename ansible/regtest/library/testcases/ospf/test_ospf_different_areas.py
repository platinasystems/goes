#!/usr/bin/python
""" Test/Verify OSPF with Different Areas """
...
DOCUMENTATION = """
---
module: test_ospf_different_areas
author: Platina Systems
short_description: Module to test and verify ospf configuration with
different areas.
description:
...
def verify_ospf_with_different_areas(module):
    """
    Method to verify ospf with different areas.
    :param module: The Ansible module to fetch input parameters.
    """
...
def main():
    ...
    verify_ospf_with_different_areas(module)
