...
const fanspeed0_min, fanspeed0_max = 1000, 23000
const tmon_bmc_cpu_min, tmon_bmc_cpu_max = 20.00, 40.00
const tmon_fan_rear_min, tmon_fan_rear_max = 20.00, 40.00
const tmon_fan_front_min, tmon_fan_front_max = 20.00, 40.00
