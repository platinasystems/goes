...
//go:generate echo elib...
//go:generate go install -v -buildmode=archive ./elib/...
...
//go:generate env GOPATH=$PWD:$GOPATH go build -o ../bin/goesd-platina-mk1 github.com/platinasystems/go/goes/goesd-platina-mk1
