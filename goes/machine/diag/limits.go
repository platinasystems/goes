...
const vmon_1v0_tha_min, vmon_1v0_tha_max = 0.950, 1.050
...
const fanspeedlow_min, fanspeedlow_max = 2000, 6000
const fanspeedmed_min, fanspeedmed_max = 7000, 11000
const fanspeedhigh_min, fanspeedhigh_max = 13000, 20000
const tmon_bmc_cpu_min, tmon_bmc_cpu_max = 20.00, 60.00
const tmon_fan_rear_min, tmon_fan_rear_max = 20.00, 60.00
const tmon_fan_front_min, tmon_fan_front_max = 20.00, 60.00
