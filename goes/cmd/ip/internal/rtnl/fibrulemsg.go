...
func FibRuleMsgPtr(b []byte) *FibRuleMsg {
	if len(b) < SizeofHdr+SizeofFibRuleMsg {
		return nil
	}
	return (*FibRuleMsg)(unsafe.Pointer(&b[SizeofHdr]))
}
...
func FibRuleUidRangePtr(b []byte) *FibRuleUidRange {
	if len(b) < SizeofHdr+SizeofFibRuleUidRange {
		return nil
	}
	return (*FibRuleUidRange)(unsafe.Pointer(&b[SizeofHdr]))
}
