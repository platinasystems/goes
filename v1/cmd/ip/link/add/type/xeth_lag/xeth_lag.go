...
const usage = "ip link add [[ name ] NAME ] link LINK type xeth-lag"

type Command struct{}

func (Command) String() string { return "xeth-lag" }
...
func (Command) Apropos() lang.Alt {
	return lang.Alt{
		lang.EnUS: "add proxy link-aggregation-group",
	}
}
...
func (Command) Man() lang.Alt {
	return lang.Alt{
		lang.EnUS: `
SEE ALSO
	ip link add type man xeth-lag || ip link add type xeth-lag -man
