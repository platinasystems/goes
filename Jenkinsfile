...
pipeline {
	...
	stage('Build') {
		...
		dir('/home/jenkins/workspace/go/src/github.com/platinasystems/go') {
		    echo "Building goes..."
		    sh 'env PATH=/usr/local/go/bin:${PATH} GOPATH=/home/jenkins/workspace/go make -B goes-platina-mk1'
		}
	    }
	}
    }
