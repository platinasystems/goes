...
func init() {
	r := (*rx_pipe_regs)(regs_base)
	m := (*rx_pipe_mems)(regs_base)
	...
	check("iss_bank_config", unsafe.Pointer(&r.iss_bank_config), 0x38004100)
...
func init() {
	r := (*tx_pipe_regs)(regs_base)
	m := (*tx_pipe_mems)(regs_base)
...
func init() {
	r := (*mmu_xpe_regs)(regs_base)
	m := (*mmu_xpe_mems)(regs_base)
...
func init() {
	r := (*mmu_sc_regs)(regs_base)
	m := (*mmu_sc_mems)(regs_base)
