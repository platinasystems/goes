...
// generated from gentemplate [gentemplate -d Package=cmic -id interruptHandler -d VecType=interruptHandlerVec -d Type=interruptHandler github.com/platinasystems/go/elib/vec.tmpl]
